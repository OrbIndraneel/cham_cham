...
import { AlertOctagon, PhoneCall, X, MapPin, CheckCircle2, ShieldAlert, Radio, AlertTriangle } from 'lucide-react-native';
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.topBar}>
        ...
        <Text style={styles.screenTitle}>{t('emergencySosDispatch')}</Text>
        <View style={{ width: 32 }} />
      </View>
